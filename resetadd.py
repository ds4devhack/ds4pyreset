...
def main(argv):
    ...
    if dev == None or dev == False or dev == 0:
        ...
        print 'You may need to install a filter driver before libusb can access the device, use "install-filter-win.exe" from libusb-win32 or the Ds4 Driver for Linux'
        quit()
...
def printHelp():
    ...
    print ''
    print 'By Frank Zhao and ROM-PacMe'
